package ar.edu.unlu.spgda.config.security;
...
import ar.edu.unlu.spgda.config.ApplicationProperties;
...
public class SecurityConfig {
    ...
    private JwtAuthenticationConverter makePermissionsConverter() {
        ...
        jwtAuthoritiesConverter.setAuthoritiesClaimName("https://spgda.unlu.edu.ar/roles");
