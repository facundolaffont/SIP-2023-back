...
INSERT INTO cursada_docente (id_Cursada, id_Docente, nivel_Permiso) VALUES
    ...
    ,(1, 'auth0|64b40e41f7a0dfd00ea3c4df', 1)
    ,(2, 'auth0|64b40e41f7a0dfd00ea3c4df', 1)
;
...
INSERT INTO evento_cursada (id_Tipo, id_Cursada, obligatorio, fecha_Hora_Inicio, fecha_Hora_Fin) VALUES
    ...
    -- ID de cursada: 2.
        ...
        -- Tipo de evento: clase.
            ...
            ,(1, 2, true,   '2021-03-01 10:00:00.000000', '2021-03-01 12:00:00.000000')
            ,(1, 2, true,   '2021-03-02 10:00:00.000000', '2021-03-02 12:00:00.000000')
            ,(1, 2, true,   '2021-03-03 10:00:00.000000', '2021-03-03 12:00:00.000000')
            ,(1, 2, true,   '2021-03-04 10:00:00.000000', '2021-03-04 12:00:00.000000')
            ,(1, 2, true,   '2021-03-05 10:00:00.000000', '2021-03-05 12:00:00.000000')
            ,(1, 2, true,   '2021-03-06 10:00:00.000000', '2021-03-06 12:00:00.000000')
            ,(1, 2, true,   '2021-03-07 10:00:00.000000', '2021-03-07 12:00:00.000000')
            ,(1, 2, true,   '2021-03-08 10:00:00.000000', '2021-03-08 12:00:00.000000')
            ,(1, 2, true,   '2021-03-09 10:00:00.000000', '2021-03-09 12:00:00.000000')
            ,(1, 2, true,   '2021-03-10 10:00:00.000000', '2021-03-10 12:00:00.000000')

        -- Tipo de evento: Trabajo práctico.

            ,(2, 2, true, '2021-04-01 10:00:00.000000', '2021-04-01 12:00:00.000000')
            ,(2, 2, true, '2021-04-02 10:00:00.000000', '2021-04-02 12:00:00.000000')
            ,(2, 2, true, '2021-04-03 10:00:00.000000', '2021-04-03 12:00:00.000000')
            ,(2, 2, true, '2021-04-04 10:00:00.000000', '2021-04-04 12:00:00.000000')

        -- Tipo de evento: Parcial.

            ,(3, 2, true, '2021-05-01 10:00:00.000000', '2021-05-01 12:00:00.000000')
            ,(3, 2, true, '2021-05-02 10:00:00.000000', '2021-05-02 12:00:00.000000')

        -- Tipo de evento: Autoevaluación.

            ,(4, 2, true, '2021-06-01 10:00:00.000000', '2021-06-01 12:00:00.000000')
            ,(4, 2, true, '2021-06-02 10:00:00.000000', '2021-06-02 12:00:00.000000')
            ,(4, 2, true, '2021-06-03 10:00:00.000000', '2021-06-03 12:00:00.000000')
            ,(4, 2, true, '2021-06-04 10:00:00.000000', '2021-06-04 12:00:00.000000')
            ,(4, 2, true, '2021-06-05 10:00:00.000000', '2021-06-05 12:00:00.000000')
            ,(4, 2, true, '2021-06-06 10:00:00.000000', '2021-06-06 12:00:00.000000')

        -- Tipo de evento: Recuperatorio trabajo práctico.

            ,(5, 2, true, '2021-07-01 10:00:00.000000', '2021-07-01 12:00:00.000000')
            ,(5, 2, true, '2021-07-02 10:00:00.000000', '2021-07-02 12:00:00.000000')

        -- Tipo de evento: Recuperatorio parcial.

            ,(6, 2, true, '2021-08-01 10:00:00.000000', '2021-08-01 12:00:00.000000')

        -- Tipo de evento: Recuperatorio autoevaluación.

            ,(7, 2, true, '2021-09-01 10:00:00.000000', '2021-09-01 12:00:00.000000')
            ,(7, 2, true, '2021-09-02 10:00:00.000000', '2021-09-02 12:00:00.000000')
            ,(7, 2, true, '2021-09-03 10:00:00.000000', '2021-09-03 12:00:00.000000')

        -- Tipo de evento: Integrador.

            ,(8, 2, true, '2021-10-01 10:00:00.000000', '2021-10-01 12:00:00.000000')

    -- ID de cursada: 3.

        -- Tipo de evento: clase.

            ,(1, 3, true, '2021-03-01 10:00:00.000000', '2021-03-01 12:00:00.000000')
...
INSERT INTO evento_cursada_alumno (id_Evento, id_Alumno, asistencia, nota) VALUES
    ...
    -- ID de cursada: 2.
        ...
        -- Tipo de evento: clase.
            ...
            -- id_evento: 36
            --,(1, 2, false,  '2021-03-06 10:00:00.000000', '2021-03-06 12:00:00.000000')
